     ...
     <div class="col-md-8 order-md-8">
       ...
       <ul class="list-group mb-6">
         ...
         <li class="list-group-item d-flex justify-content-between lh-condensed">
           ...
           <input type="number" name="menge"  placeholder="<?php echo $_SESSION['menge'] ?>"
          ...
          <a type = "button" name= "Entfernen" class="btn btn-sm btn-outline-secondary" href = "warenkorb.php?position_id_wa=<?php echo $data['position_id']; ?>">Entfernen</a>
           Farbe
           <select name="farbe">
           ...
           <span class="text-muted"><?php echo $produktnummer['verkaufspreis']* $_SESSION['menge']; ?> €</span>
           <?php $summe += $produktnummer['verkaufspreis']* $_SESSION['menge']; ?>
         </li>
       <?php } ?>
       </from>
