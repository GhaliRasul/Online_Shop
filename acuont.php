...
<div class="navbar navbar-dark bg-dark shadow-sm">
  <div class="container d-flex justify-content-between">
    ...
    <div class="container">
     ...
     <?php
     $kunde =  getkunden($_SESSION['kundennummer']); // kunden ändern?>

    <h2>Hallo <?php echo $kunde['vorname']; echo ' '; echo $kunde['name'];?></h2>
    <p class="lead">Hier können Sie Ihre perönliche Daten ändern oder Ihre Bestellungen anzusehen.</p>
  </div>
  </div>
</header>
...
<main role="main">
  <form class="needs-validation" novalidate method="post">
    ...
    <div class="col-md-8 order-md-1">
      <hr class="mb-4">
         <a type="text" class="btn btn-primary btn-lg btn-block"  href="datenaedern.php">Meine Daten ändern</a>
         <a type="text" class="btn btn-primary btn-lg btn-block"  href="bestellungen.php">Bestellungen</a>
      </div>
    </center>
    </br>
   </br>
