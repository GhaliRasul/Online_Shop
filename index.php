  ...
  <section class="jumbotron text-center">
    <div class="container">
      <a  id="m-logo"><img alt="Shoe Market" class="img-fluid" src="https://static1.mysiteserver.net/images/theshoemarket/site/template/shoe-market-logo.png"> </a>
        ...
        <a href="Damen.php" class="navbar-brand d-flex align-items-center">
          <strong >Damen</strong>
        </a>
        <a href="Herren.php" class="navbar-brand d-flex align-items-center">
          <strong >Herren</strong>
        </a>
        <a href="Kinder.php" class="navbar-brand d-flex align-items-center">
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a type="button" class="btn btn-sm btn-outline-secondary" href="Login.php?">Bestellen</a>
                    </div>
